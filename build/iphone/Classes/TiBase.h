...
// in simulator we redefine to format for Cielito Developer console
...
{\
	NSString * exceptionName = [@"org.cielito." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cielito";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UICielitoNativeItemNone = -1, 
	UICielitoNativeItemSpinner = -2,
	UICielitoNativeItemProgressBar = -3,
	
	UICielitoNativeItemSlider = -4,
	UICielitoNativeItemSwitch = -5,
	UICielitoNativeItemMultiButton = -6,
	UICielitoNativeItemSegmented = -7,
	
	UICielitoNativeItemTextView = -8,
	UICielitoNativeItemTextField = -9,
	UICielitoNativeItemSearchBar = -10,
	
	UICielitoNativeItemPicker = -11,
	UICielitoNativeItemDatePicker = -12,
	
	UICielitoNativeItemInfoLight = -13,
	UICielitoNativeItemInfoDark = -14,
	
	UICielitoNativeItemDisclosure = -15,
	
	UICielitoNativeItemContactAdd = -16
};
