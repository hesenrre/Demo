...
//@interface CielitoObject : NSObject
//@end

@interface CielitoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CielitoObject class]])
		{
			for (NSString *key in [[(CielitoObject*)o modules] allKeys])
			{
